...
(function ($, _, widgetData) {
    $(document).ready(function () {
        ...
        Vue.component('modal', {
            template: '#tmpl-wha-social-modal',
            ...
            methods: {
                clickOnIcon: function ($event) {
                    ...
                    $(this.$el).find('.wha-social-icons__single-element').css($rule, this.modal_color_picker);
                },
            ...
            mounted: function () {
                this.$nextTick(function () {
                    var $colorPickers = $(this.$el).find('.wha-social-icons__field-color-picker');
                    var $scrollableDiv = $(this.$el).find('.modal-icons-wrapper');
                    $scrollableDiv.scrollTo('.wha-social-icons__single-element.selected');
            ...
            new Vue({
                ...
                methods: {
                    ...
                    insertField: function (e) {
                        ...
                        this.$nextTick(function () {
                            $(this.$el).find('.wha-social-icons__field').eq(this.fields.length - 1).find('.wha-social-icons__field-url').focus();
                        });
                    },
        ...
        $(document).on('panelsopen', function (e) {
            ...
            if (!dialog.has('.wha-social-icons__list')) return;
...
})(jQuery, _, wha_social_widget_data);